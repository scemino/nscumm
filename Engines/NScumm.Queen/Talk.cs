...
namespace NScumm.Queen
{
    ...
    class Talk
    {
            ...
            int index)
        {
            ...
            string segment = segmentStart.Substring(0, length);
        ...
        void StringAnimation(SpeechParameters parameters, int startFrame, int bankNum)
        {
        ...
        void HeadStringAnimation(SpeechParameters parameters, int bobNum, int bankNum)
        {
            // talk.c lines 1612-1635
        ...
        SpeechParameters FindSpeechParameters(string name, int state, Direction faceDirection)
        {
            var iterator = 0;
        ...
        void DefaultAnimation(string segment, bool isJoe, SpeechParameters parameters, int startFrame, ushort bankNum)
        {
            if (segment.Length > 0)
            {
 ...
 new SpeechParameters( "JOE", 6, 4, 5, 38, 1, 0, "", 0 ),
  ...
  new SpeechParameters( "JOE", 7, 4, 5, 38, 1, 0, "", 0 ),
   ...
   new SpeechParameters( "JOE", 10, 1, 1, 12, 0, 0, "T046,010,010,010,012,012,012,012,012,012,012,012,012,012,012,012,012,012,010,000", 0 ),
  ...
  new SpeechParameters( "JOE", 13, 1, 1, 10, 2, 3, "T012,013,019,019,019,019,019,019,019,019,019,019,013,010,000", 0 ),
  ...
  new SpeechParameters( "SPARKY-F", 14, 0, 45, 29, 5, 0, "", 29 ),
    ...
    new SpeechParameters( "WITCH", 4, 0, 39, 40,  2, 6, "T052,053,054,055,056,057,058,057,056,056,056,055,054,053,052,000", 40 ),
 ...
 new SpeechParameters( "APE2", 0, 0, 14,  6, 7, 0, "", 6 ),
  ...
  new SpeechParameters( "DOG", 2, 0, 6, 6, 1, 0, "008,009,010,000", 0 ),
   ...
   new SpeechParameters( "CHEF", 0, 0, 5, 6, 2, 3, "", 6 ),
    ...
    new SpeechParameters( "JOHAN", 2, 0, 1, 15,  2, 3, "T002,003,004,005,004,005,004,005,004,005,004,005,004,003,002,000", 15 ),
    ...
    new SpeechParameters( "FRANK", 2, 0, 13, 14, 2, 3, "025,026,027,027,027,026,026,026,027,027,026,026,027,025,013,000", 14 ),
    ...
    new SpeechParameters( "DEATH", 3, 0, 1, 2, 2, 3, "T018,019,020,021,021,022,022,020,021,022,020,021,022,023,024,524,000", 2 ),
    new SpeechParameters( "DEATH", 4, 0, 1, 2, 2, 3, "T025,026,027,028,028,028,028,028,028,028,028,028,029,035,000", 2 ),
    new SpeechParameters( "DEATH", 5, 0, 1, 2, 2, 3, "T030,031,032,033,033,033,033,033,033,033,033,033,034,035,000", 2 ),
