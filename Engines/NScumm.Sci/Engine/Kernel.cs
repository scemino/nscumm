...
namespace NScumm.Sci.Engine
{
    ...
    class SciKernelMapEntry
    {
        ...
        public static SciKernelMapEntry MakeDummy(string name, SciVersionRange range, string signature, SciKernelMapSubEntry[] subSignatures = null, SciWorkaroundEntry[] workarounds = null)
        {
            return new SciKernelMapEntry { name = name, function = Kernel.kDummy, fromVersion = range.fromVersion, toVersion = range.toVersion, forPlatform = range.forPlatform, signature = signature, subFunctions = subSignatures, workarounds = workarounds };
        }
    }
    ...
    partial class Kernel
    {
        ...
        static readonly SciKernelMapSubEntry[] kPalette_subops = {
            ...
            SciKernelMapSubEntry.Make(SciVersionRange.SIG_SCIALL(0),          3, kPaletteUnsetFlag,          "iii",                  Workarounds.kPaletteUnsetFlag_workarounds),
        ...
        static readonly SciKernelMapEntry[] s_kernelMap =
        {
            ...
            SciKernelMapEntry.Make(kDeviceInfo,SciVersionRange.SIG_EVERYWHERE,"i(r)(r)(i)",null,Workarounds.kDeviceInfo_workarounds), // subop
            ...
            SciKernelMapEntry.Make(kMemory,SciVersionRange.SIG_EVERYWHERE,"i(.*)",null,Workarounds.kMemory_workarounds), // subop
            ...
            SciKernelMapEntry.Make(kStrCpy,SciVersionRange.SIG_EVERYWHERE,"r[r0](i)",null,Workarounds.kStrCpy_workarounds),
            SciKernelMapEntry.Make(kStrEnd,SciVersionRange.SIG_EVERYWHERE,"r",null,null),
            SciKernelMapEntry.Make(kStrLen,SciVersionRange.SIG_EVERYWHERE,"[r0]",null,Workarounds.kStrLen_workarounds),
            ...
            SciKernelMapEntry.Make(kUnLoad,SciVersionRange.SIG_EVERYWHERE,"i[ir!]",null,Workarounds.kUnLoad_workarounds),
