...
namespace NScumm.Sci.Engine
{
    ...
    internal static class Workarounds
    {
        ...
        public static readonly SciWorkaroundEntry[] kNumCels_workarounds = 
        {
            new SciWorkaroundEntry { gameId = SciGameId.GK1, roomNr = 460, scriptNr = 64998, inheritanceLevel = -1, objectName =       "GKEgo", methodName = "lastCel",     index =  -1, newValue = new SciWorkaroundSolution { type = SciWorkaroundType.FAKE, value = 5 } }, // when Gabriel clicks "ask" on the bartender from a distance
	        new SciWorkaroundEntry { gameId = SciGameId.GK1, roomNr = 808, scriptNr = 64998, inheritanceLevel = -1, objectName =   "sDJEnters", methodName = "changeState", index =  -1, newValue = new SciWorkaroundSolution { type = SciWorkaroundType.FAKE, value = 6 } }, //
	        new SciWorkaroundEntry { gameId = SciGameId.GK2, roomNr = 470, scriptNr = 64998, inheritanceLevel = -1, objectName = "pLookieLoos", methodName = "lastCel",     index =  -1, newValue = new SciWorkaroundSolution { type = SciWorkaroundType.FAKE, value = 50 } }, // random background movement in the crime scene in Munich city centre
	        new SciWorkaroundEntry { gameId = SciGameId.GK2, roomNr = 470, scriptNr = 64998, inheritanceLevel = -1, objectName =   "pNewsCrew", methodName = "lastCel",     index =  -1, newValue = new SciWorkaroundSolution { type = SciWorkaroundType.FAKE, value = 18 } }, // random background movement in the crime scene in Munich city centre
	        new SciWorkaroundEntry { gameId = SciGameId.GK2, roomNr = 470, scriptNr = 64998, inheritanceLevel = -1, objectName = "pLeberGroup", methodName = "lastCel",     index =  -1, newValue = new SciWorkaroundSolution { type = SciWorkaroundType.FAKE, value = 22 } }, // random background movement in the crime scene in Munich city centre
	        new SciWorkaroundEntry { gameId = SciGameId.SQ6, roomNr = 270, scriptNr = 64998, inheritanceLevel = -1, objectName =    "offWorld", methodName = "lastCel",     index =  -1, newValue = new SciWorkaroundSolution { type = SciWorkaroundType.FAKE, value = 3 } }, // when exiting the kidnapping room
	        new SciWorkaroundEntry { gameId = SciGameId.SQ6, roomNr = 320, scriptNr = 64998, inheritanceLevel = -1, objectName =   "wandererB", methodName = "lastCel",     index =  -1, newValue = new SciWorkaroundSolution { type = SciWorkaroundType.FAKE, value = 8 } }, // random background movement on Polysorbate LX street 3
	        new SciWorkaroundEntry { gameId = SciGameId.SQ6, roomNr = 340, scriptNr = 64998, inheritanceLevel = -1, objectName =   "wandererB", methodName = "lastCel",     index =  -1, newValue = new SciWorkaroundSolution { type = SciWorkaroundType.FAKE, value = 8 } }, // random background movement on Polysorbate LX street 1
	        new SciWorkaroundEntry { gameId = SciGameId.SQ6, roomNr = 530, scriptNr = 64998, inheritanceLevel = -1, objectName =    "monitors", methodName = "lastCel",     index =  -1, newValue = new SciWorkaroundSolution { type = SciWorkaroundType.FAKE, value = 5 } }, // random background movement during cutscene
	        new SciWorkaroundEntry { gameId = SciGameId.SQ6, roomNr = 680, scriptNr = 64998, inheritanceLevel = -1, objectName =         "ego", methodName = "lastCel",     index =  -1, newValue = new SciWorkaroundSolution { type = SciWorkaroundType.FAKE, value = 44 } }, // when double-clicking hand icon on blockage
        };
