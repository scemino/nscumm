...
namespace NScumm.Sci.Graphics
{
    ...
    internal class GfxPaint16 : GfxPaint
    {
        ...
        {
            _coordAdjuster.KernelLocalToGlobal(ref rect.Left, ref rect.Top);
            _coordAdjuster.KernelLocalToGlobal(ref rect.Right, ref rect.Bottom);
            Port oldPort = _ports.SetPort(_ports._picWind);
            _coordAdjuster.KernelGlobalToLocal(ref rect.Left, ref rect.Top);
            _coordAdjuster.KernelGlobalToLocal(ref rect.Right, ref rect.Bottom);
