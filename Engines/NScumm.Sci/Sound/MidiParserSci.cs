...
namespace NScumm.Sci.Sound
{
    ...
    class MidiParser_SCI : MidiParser
    {
        ...
        internal void SendInitCommands()
        {
        }

        internal void MainThreadEnd()
        {
        }
        ...
        internal void SetMasterVolume(byte vol)
        {
        }

        public sbyte SongReverb { get; internal set; }

        internal void LoadMusic(SoundResource.Track track, MusicEntry pSnd, int channelFilterMask, SciVersion _soundVersion)
        {
        }
   }
    ...
    //    NumTracks = 1;
    //    Tracks[0] = new ByteAccess(_mixedData);
    //    if (_pSnd != null)
    //    {
    //        ActiveTrack = 0;
    //    }
    ...
    //    }
    //    info.Delta += Position.PlayPos.Increment();
