...
namespace NScumm.Scumm.Graphics
{
    ...
    {
        public static Palette Ega => egaPalette ?? (egaPalette = CreatePalette(tableEGAPalette));

        public static Palette Cga => cgaPalette ?? (cgaPalette = CreatePalette(tableCGAPalette));

        public static Palette V1 => v1Palette ?? (v1Palette = CreatePalette(tableV1Palette));

        public static Palette C64 => c64Palette ?? (c64Palette = CreatePalette(tableC64Palette));

        public static Palette Amiga => amigaPalette ?? (amigaPalette = CreatePalette(tableAmigaPalette));

        public static Palette AmigaMonkeyIsland => amigaMonkeyIslandPalette ?? (amigaMonkeyIslandPalette = CreatePalette(tableAmigaMonkeyIslandPalette));

        public static Palette Towns3 => towns3Palette ?? (towns3Palette = CreatePalette(tableTowns3Palette));

        public static Palette TownsLoom => townsLoomPalette ?? (townsLoomPalette = CreatePalette(tableTownsLoomPalette));
        ...
        private static Palette CreatePalette(Color[] colors)
        {
        ...
        private static readonly Color[] tableEGAPalette =
            {
        ...
        private static readonly Color[] tableC64Palette =
            {
        ...
        private static readonly Color[] tableAmigaPalette =
            {
        ...
        private static readonly Color[] tableAmigaMonkeyIslandPalette =
            {
        ...
        private static readonly Color[] tableTowns3Palette =
            {
        ...
        private static readonly Color[] tableTownsLoomPalette =
            {
        ...
        private static Palette egaPalette;
        private static Palette cgaPalette;
        private static Palette v1Palette;
        private static Palette c64Palette;
        private static Palette amigaPalette;
        private static Palette amigaMonkeyIslandPalette;
        private static Palette towns3Palette;
        private static Palette townsLoomPalette;
    }
}
