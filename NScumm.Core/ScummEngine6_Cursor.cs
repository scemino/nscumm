...
namespace NScumm.Core
{
    partial class ScummEngine6
    {
        ...
        static readonly byte[] default_v6_cursor = new byte[]
        {
            ...
            switch (subOp)
            {
                ...
                case 0x9D:              // SO_CHARSET_COLOR
                    ...
                    for (var i = 0; i < args.Length; i++)
                        CharsetColorMap[i] = _charsetData[_string[1].Default.Charset][i] = (byte)args[i];
                    break;
        ...
        void SetCursorFromImg(int obj, int room, int index)
        {
            ...
            UseIm01Cursor(img, ob.Width, ob.Height);
        }

        void UseIm01Cursor(ImageData im, int w, int h)
        {
