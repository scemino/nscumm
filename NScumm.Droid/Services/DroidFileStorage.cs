...
{
    internal class DroidFileStorage : IFileStorage
    {
        ...
        {
            var resourcePrefix = "NScumm.Droid.Res.";
            var assembly = typeof(DroidFileStorage).Assembly;
            var stream = assembly.GetManifestResourceStream(resourcePrefix + path.Replace('/','.'));
            return stream;
        }
