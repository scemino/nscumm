        ...
        Statement ResourceRoutines()
        {
            ...
            switch (subOp)
            {
                ...
                case 112:               // SO_UNLOCK_SCRIPT
                    {
                        var resId = Pop();
                        exp = new MethodInvocation(new MemberAccess(exp, "UnlockSxcript")).AddArgument(resId);
                    }
                    break;
                ...
                default:
                    throw new NotSupportedException(string.Format("o6_resourceRoutines: default case {0}", subOp));
            }
