...
{
    class ResourceManager6: ResourceManager5
    {
        public ResourceManager6(GameInfo game)
            : base(game)
        {           
        }
        ...
        {
            var res = ((ResourceIndex6)Index).CharsetResources[id];
            var diskNum = res.RoomNum;
            var file = (ResourceFile6)OpenRoom(diskNum);
